 ...
 */
	public function add() {
		...
		$deliveryMethods = $this->DeliveryMethodsInput->DeliveryMethod->find('list');
		$inputs = $this->DeliveryMethodsInput->Input->find('list');
		$this->set(compact('deliveryMethods', 'inputs'));
	}
